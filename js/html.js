...
< title > adventure.land | 522: Connection timed out < /title>
...
< span class = "cf-error-type" > Error < /span>
              <span class="cf-error-code">522</span > < small class = "heading-ray-id" > Ray ID: 42159295d7db9720 & bull;
2018 - 05 - 27 04: 00: 21 UTC < /small>
            </h1 > < h2 class = "cf-subheadline" > Connection timed out < /h2>
        </div > <!--
/.error-overview -->
...
class = "cf-column cf-status-item cf-cloudflare-status " > < div class = "cf-icon-error-container" > < i class = "cf-icon cf-icon-cloud" > < /i>
  ...
  <span class="cf-status-desc">Frankfurt</span > < h3 class = "cf-status-name" > Cloudflare < /h3>
...
< div class = "cf-section cf-wrapper" > < div class = "cf-columns two" > < div class = "cf-column" > < h2 > What happened ? < /h2>
                    <p>The initial connection between Cloudflare's network and the origin web server timed out. As a result, the web page can not be displayed.</p > < /div>
...
re the owner of this website : < /h5>
      <p><span>Contact your hosting provider letting them know your web server is not completing requests. An Error 522 means that the request was able to connect to your web server, but that the request didn't finish. The most likely cause is that something on your server is hogging resources.</span > < a href = "https://support.cloudflare.com/hc/en-us/articles/200171906-Error-522" > Additional troubleshooting information here. < /a></p > < /div>
            </div >

< /div><!-- /.section-- >

< div class = "cf-error-footer cf-wrapper" > < p > < span class = "cf-footer-item" > Cloudflare Ray ID: < strong > 42159295d7db9720 < /strong></span > < span class = "cf-footer-separator" > & bull; < /span>
